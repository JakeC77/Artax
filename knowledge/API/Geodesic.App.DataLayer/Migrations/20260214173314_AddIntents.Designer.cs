...
namespace Geodesic.App.DataLayer.Migrations
{
    ...
    [Migration("20260214173314_AddIntents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Geodesic.App.DataLayer.Entities.Company", b =>
                {
            ...
            modelBuilder.Entity("Geodesic.App.DataLayer.Entities.DataLoadingAttachment", b =>
                {
                    ...
                    b.HasKey("AttachmentId")
                        .HasName("pk_data_loading_attachments");

                    b.HasIndex("OntologyId")
                        .HasDatabaseName("ix_data_loading_attachments_ontology_id");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_data_loading_attachments_tenant_id");

                    b.ToTable("data_loading_attachments", "app");
                });
            ...
            modelBuilder.Entity("Geodesic.App.DataLayer.Entities.Intent", b =>
                {
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_intents_tenant_id");

                    b.HasIndex("TenantId", "OpId")
                        .IsUnique()
                        .HasDatabaseName("ix_intents_tenant_id_op_id");

                    b.ToTable("intents", "app");
                });

            modelBuilder.Entity("Geodesic.App.DataLayer.Entities.Ontology", b =>
                {
                    b.Property<Guid>("OntologyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DomainExamples")
                        .HasColumnType("text")
                        .HasColumnName("domain_examples");

                    b.Property<string>("JsonUri")
                        .HasColumnType("text")
                        .HasColumnName("json_uri");
                    ...
                    b.Property<string>("Neo4jEncryptedPassword")
                        .HasColumnType("text")
                        .HasColumnName("neo4j_encrypted_password");

                    b.Property<string>("Neo4jUri")
                        .HasColumnType("text")
                        .HasColumnName("neo4j_uri");

                    b.Property<string>("Neo4jUsername")
                        .HasColumnType("text")
                        .HasColumnName("neo4j_username");
                    ...
                    b.HasKey("OntologyId")
                        .HasName("pk_ontologies");

                    b.HasIndex("CompanyId")
                        .HasDatabaseName("ix_ontologies_company_id");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_ontologies_tenant_id");

                    b.ToTable("ontologies", "app");
                });
            ...
            modelBuilder.Entity("Geodesic.App.DataLayer.Entities.SemanticEntity", b =>
                {
                    ...
                    b.HasIndex("OntologyId")
                        .HasDatabaseName("ix_semantic_entities_ontology_id");

                    b.HasIndex("OntologyId", "NodeLabel")
                        .IsUnique()
                        .HasDatabaseName("ix_semantic_entities_ontology_id_node_label")
                        .HasFilter("ontology_id IS NOT NULL");

                    b.HasIndex("TenantId", "NodeLabel", "Version")
                        .IsUnique()
                        .HasDatabaseName("ix_semantic_entities_tenant_id_node_label_version");

                    b.HasOne("Geodesic.App.DataLayer.Entities.Ontology", null)
                        .WithMany()
                        .HasForeignKey("OntologyId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_semantic_entities_ontologies_ontology_id");
            ...
            modelBuilder.Entity("Geodesic.App.DataLayer.Entities.SemanticField", b =>
                {
                    ...
                    b.Property<string>("RangeInfo")
                        .HasColumnType("jsonb")
                        .HasColumnName("range_info");
            ...
            modelBuilder.Entity("Geodesic.App.DataLayer.Entities.Workspace", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("ix_workspaces_company_id");

                    b.HasIndex("OntologyId")
                        .HasDatabaseName("ix_workspaces_ontology_id");
